...
const WineListRecWine = ({ wines }: Props) => {
  return (
    <div className="flex flex-col lg:w-[1140px] lg:h-[300px] md:w-[704px] md:h-[299px] w-[343px] h-[241px] rounded-2xl bg-[#F2F4F8] lg:mt-[20px] md:mt-[20px] mt-[15px] lg:pt-[30px] lg:pl-[30px] md:pt-[30px] md:pl-[30px] pt-[20px] pl-[20px]">
        ...
        {wines.length > 0
          ...
          : Array.from({ length: 5 }).map((_, index) => (
              <motion.div
                ...
                className="flex flex-row items-center p-0"
              >
                <WineCardSmallSkeleton key={index} />
              </motion.div>
            ))}
      </div>
    </div>
